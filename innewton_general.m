...
while k < kmax && gradfk_norm >= tolgrad
    ...
    switch FDHess
        ...
        otherwise
            ...
            %opts.diagcomp = 10;
            %M1 = ichol(sparse(Hessf(xk)));
            %M2 = M1';
            %pk = pcg(Hessf(xk), -gradfk, epsilon_k, pcg_maxit, M1, M2);
            pk = pcg(Hessf(xk), -gradfk, epsilon_k, pcg_maxit);
    end
...
% "Cut" xseq, btseq and fkseq to the correct size
xseq = xseq(:, 1:k);
btseq = btseq(1:k);
end